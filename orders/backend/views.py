...
from backend.models import ProductInfo, Product, Parameter, ProductParameter, Category, Shop, Order, Contact
...
class BasketView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if items_sting:
            try:
                if type(items_sting) == type(''):
                    items_dict = load_json(items_sting)
                else:
                    items_dict = items_sting
            except ValueError:
                return JsonResponse({'Status': False, 'Errors': 'Invalid query format'})
            else:
    ...
    def delete(self, request, *args, **kwargs):
        ...
        if items_sting:
            ...
            if objects_deleted:
                ...
                return JsonResponse({'Status': True, 'Delete objects': deleted_count})
        return JsonResponse({'Status': False, 'Errors': 'All required arguments not provided'})
    ...
    def put(self, request, *args, **kwargs):
        ...
        if items_sting:
            try:
                ...
                return JsonResponse({'Status': True, 'Update objects': objects_updated})
        return JsonResponse({'Status': False, 'Errors': 'All required arguments not provided'})
        ...
        if {'id', 'contact'}.issubset(request.data):
            if request.data['id'].isdigit():
                try:
                    ...
                    print(error)
                    return JsonResponse({'Status': False, 'Errors': 'Incorrect argumets'})
                else:
                    if is_updated:
